...
if (!nexacro.ChartBubbleSeriesControl) {
	...
	_pChartBubbleSeriesControl._drawScatterPlot = function (x, y, radius, axisx, axisy, pointshape, _pointshape, linestyle, fillstyle, opacity, index, item) {
		var chart = this._chart, point, cx, cy, points = [], evtInfo, seriesId, seriesGroup = chart._seriesGroup, tmp, highlightGroup = chart._highlightGroup;
		x = +x;
		y = +y;
	...
	_pChartBubbleSeriesControl._drawBubble = function (x, y, data, radius, linestyle, fillstyle, opacity, index, item) {
		var circle = null, chart = this._chart, cx, cy, points = [], axisx = this._xaxis, axisy = this._yaxis, seriesId, seriesGroup = this._chart._seriesGroup, highlightGroup = this._chart._highlightGroup;
		x = +x;
		y = +y;
