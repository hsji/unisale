if (!nexacro.ExtCombo) 
{
    ...
    {
		this.usetype = "popup";
		this.popupurl = "cmm::pExtCombo.xfdl";
...
//	_pExtCombo.on_notify_drop_mobile_onclick = function (obj, e) {
	...
	_pExtCombo._on_drop_onlbuttondown = function (obj, e) {
		this.on_drop_mobile_onclick(obj, e);
	};	
	
    _pExtCombo._on_edit_onlbuttondown = function (obj, e)
    {		
	//	_pCombo._on_edit_oneditclick(obj, e);
		this.on_drop_mobile_onclick(obj, e);
    };	
