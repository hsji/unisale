(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDept","staTitle00_00:00","41","250","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("div00");
            ...
            obj = new Div("divUser","staTitle00_00_00:0","41","250","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("div00");
            obj.set_url("common::cmmUserSearch.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTitle02","divUser:0","41","98","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("로그인구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboLoginFlagCd","staTitle02:0","41","130","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("cbo00");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj.set_taborder("1");
            obj.set_text("시스템 접속 현황");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);

            obj = new Grid("grdList","0","staTitle01:0",null,null,"20","0",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_binddataset("dsList");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"68\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"로그일시\"/><Cell col=\"1\" text=\"부서명\"/><Cell col=\"2\" text=\"사번/ID\"/><Cell col=\"3\" text=\"사용자명\"/><Cell col=\"4\" text=\"직위\"/><Cell col=\"5\" text=\"로그인구분\"/><Cell col=\"6\" text=\"브라우저정보\"/><Cell col=\"7\" text=\"브라우저버전\"/><Cell col=\"8\" text=\"OS정보\"/><Cell col=\"9\" text=\"OS버전\"/><Cell col=\"10\" text=\"스크린사이즈\"/><Cell col=\"11\" text=\"모바일여부\"/></Band><Band id=\"body\"><Cell text=\"bind:ALOG_DTTM\" displaytype=\"normal\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\"/><Cell col=\"1\" text=\"bind:DEPT_NM\"/><Cell col=\"2\" text=\"bind:EMP_NO\"/><Cell col=\"3\" text=\"bind:USER_NM\"/><Cell col=\"4\" text=\"bind:WKGD_CD\"/><Cell col=\"5\" text=\"bind:LOIN_FLAG_CD\"/><Cell col=\"6\" text=\"bind:BROWSER_CD\"/><Cell col=\"7\" text=\"bind:BROWSER_VERSION\"/><Cell col=\"8\" text=\"bind:OS_CD\"/><Cell col=\"9\" text=\"bind:OS_VERSION\"/><Cell col=\"10\" text=\"bind:SCREEN_SIZE\"/><Cell col=\"11\" text=\"expr:MOB_YN==&apos;1&apos; ? &apos;Y&apos; : &apos;N&apos;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item5","divSearch.form.cboLoginFlagCd","value","dsCond","LOIN_FLAG_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("logSytmLoginFm.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("logSytmLoginFm.xfdl");
