(function()
{
    return function()
    {
        ...
        {
            this.set_name("authPermPersonalMenuAddBtnPu");
            this.set_titletext("개인별 권한 관리(추가버튼관리 팝업)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"SYTM_FLAG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PRGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new BindItem("item0","divSearch.form.edtPremId","value","dsCond","USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("authPermPersonMenuAddBtnPu.xfdl", function() {
        /**
        *  DevPACK
        *  @FileName 	authPermPersonalMenuAddBtnPu.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var strSvcId    = "searchPremUserAddBtnList";
        	var strSvcUrl   = "searchPremUserAddBtnList.do";
        ...
        {
        	var strSvcId    = "savePremUserAddBtnList";
        	var strSvcUrl   = "savePremUserAddBtnList.do";
        ...
        *******************************************************************************************************************************/
        ...
        {
        	switch(sSvcId) {
        		case "searchPremUserAddBtnList":
        			break;
        		case "savePremUserAddBtnList":
        			this.cfnSearch();
        			break;
        		default: break;
        	}
        ...
        *******************************************************************************************************************************/
        ...
        this.fnInsertRegiBtn = function ()
        {
        	...
        	this.dsPrem.setColumn(nRow, "USER_ID"		, this.dsCond.getColumn(0, "USER_ID"));
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("authPermPersonMenuAddBtnPu.xfdl");
