(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"FIELD_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"FIELD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"FIELD_MASK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"FIELD_NAME\">결재자1_의견</Col><Col id=\"FIELD_ID\">field_signcomment1</Col></Row><Row><Col id=\"FIELD_NAME\">결재자2_의견</Col><Col id=\"FIELD_ID\">field_signcomment2</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsReceiver", this);
            obj._setContents("<ColumnInfo><Column id=\"USER_REGNO\" type=\"STRING\" size=\"256\"/><Column id=\"APRV_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"USER_ID\" type=\"string\" size=\"32\"/><Column id=\"R_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"R_ORDER\" type=\"INT\" size=\"256\"/><Column id=\"MAIL_URL\" type=\"STRING\" size=\"256\"/><Column id=\"SEND_SEQ\" type=\"int\" size=\"4\"/><Column id=\"EDIT_INFO\" type=\"STRING\" size=\"256\"/><Column id=\"DOC_ID\" type=\"string\" size=\"32\"/><Column id=\"PDF_FILE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"WORK_NAME\" type=\"string\" size=\"32\"/><Column id=\"FORMER_ID\" type=\"string\" size=\"32\"/><Column id=\"USER_MAILADDR\" type=\"string\" size=\"32\"/><Column id=\"FORMER_YN\" type=\"string\" size=\"32\"/><Column id=\"FORMER_NAME\" type=\"string\" size=\"32\"/><Column id=\"USER_NAME\" type=\"string\" size=\"32\"/><Column id=\"MAILUSER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"FORMER_ORDER\" type=\"int\" size=\"4\"/><Column id=\"M_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"CHGE_ID\" type=\"STRING\" size=\"256\"/><Column id=\"USER_PHONE\" type=\"string\" size=\"32\"/><Column id=\"COMP_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"PDF_ORIG_FILE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PDF_FILE_PATH_NM\" type=\"STRING\" size=\"256\"/><Column id=\"INPT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCond", this);
            obj._setContents("<ColumnInfo><Column id=\"DOC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"SEND_SEQ\" type=\"INT\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new UbiDocuMaker("UbiDocuMaker00","0","70",null,null,"0","70",null,null,null,null,this);
            obj.set_taborder("29");
        ...
        // User Script
        this.registerScript("mtgManagerMail.xfdl", function() {
        /**
        *  메일발송
        ...
        */
        this.docEditor_onload = function(obj,e)
        {
        	...
        	this.dsDocInfo.copyRow(0, this.opener.dsDocInfo, this.opener.dsDocInfo.rowposition)
        	...
        	this.Calendar00_00.set_value(this.gfnAddDate(date, 15));
        	...
        	this.UbiDocuMaker00.set_editorPath("svcUrl::tobemeeting/ubidocumaker");	// test
        ...
        */
        ...
        {
        	var arrMap = ["meet","meet","meet"];
        	var arrMapId = ["MeetUserList","MeetSignUserList", "MeetFormerList"];
        	var arrOut = ["dsUser","dsSignUser","dsFormerInfo"];
        	...
        	var outData     = "dsUser=dsUser dsSignUser=dsSignUser dsFormerInfo=dsFormerInfo";
        	var strArg      = "";
        ...
        */
        this.fnCallback = function(srvId, errCode, errMsg)
        {
        	...
        	if(srvId == "searchDocuDetail") {
        		...
        		// 작성, 수신 그룹데이터 복사
        // 		this.dsFormerInfo.copyData(this.dsUser);
        // 		this.dsFormerInfo.insertRow(0);
        // 		this.dsFormerInfo.setColumn(0, "DOC_ID", this.dsDocInfo.getColumn(0, "DOC_ID"));
        // 		this.dsFormerInfo.setColumn(0, "FORMER_ID", this.dsDocInfo.getColumn(0, "INPT_ID"));
        // 		this.dsFormerInfo.setColumn(0, "FORMER_YN", "Y");
        // 		this.dsFormerInfo.setColumn(0, "FORMER_NAME", this.dsDocInfo.getColumn(0, "USER_NAME"));

        		// 수신자 복사
        		this.dsReceiver.set_enableevent(false);
        		this.dsReceiver.copyData(this.dsUser);
        		if(this.fvDocType == "N") {
        			for(var i=0;i<this.dsReceiver.rowcount;i++) {
        				this.dsReceiver.setColumn(i, "R_ORDER", 1);	// 수신자로 세팅
        			}
        		}
        		this.dsReceiver.addColumn("USER_TYPE", "string", 1);
        // 		for(var i=0;i<this.dsReceiver.rowcount;i++) {
        // 			this.dsReceiver.setColumn(i, "FORMER_ID", this.dsFormerInfo.getColumn(1, "FORMER_ID"));	// 수신자로 세팅
        // 		}
        		if(this.dsSignUser.rowcount == 0) {
        			this.radCheck00_00.set_readonly(true);
        		}
        		// 결재자 추가
        		if(this.fvDocType == "N") {
        			for(var i=this.dsSignUser.rowcount-1;i>=0;i--) {

        	// 			this.dsFormerInfo.insertRow(0);
        	// 			this.dsFormerInfo.setColumn(0, "DOC_ID", this.dsDocInfo.getColumn(0,"DOC_ID"));
        	// 			this.dsFormerInfo.setColumn(0, "FORMER_ID", this.fvFormerPrefix + this.dsSignUser.getColumn(i, "USER_ID"));
        	// 			this.dsFormerInfo.setColumn(0, "FORMER_NAME", this.dsSignUser.getColumn(i, "USER_NAME"));
        	// 			this.dsFormerInfo.setColumn(0, "FORMER_YN", "N");

        				this.dsReceiver.insertRow(0);
        				this.dsReceiver.setColumn(0, "USER_TYPE", "S");
        				this.dsReceiver.setColumn(0, "R_ORDER", (i+2));
        				this.dsReceiver.setColumn(0, "USER_ID", this.dsSignUser.getColumn(i, "USER_ID"));
        				this.dsReceiver.setColumn(0, "USER_NAME", this.dsSignUser.getColumn(i, "USER_NAME"));
        				this.dsReceiver.setColumn(0, "USER_MAILADDR", this.dsSignUser.getColumn(i, "USER_MAILADDR"));
        				this.dsReceiver.setColumn(0, "USER_PHONE", this.dsSignUser.getColumn(i, "USER_PHONE"));
        				this.dsReceiver.setColumn(0, "FORMER_ID", this.fvFormerPrefix + this.dsSignUser.getColumn(i, "USER_ID"));	// 결재자로 세팅
        				this.dsReceiver.setColumn(0, "FORMER_NAME", this.dsSignUser.getColumn(i, "USER_NAME"));	// 결재자로 세팅
        				this.dsReceiver.setColumn(0, "FORMER_YN", "N");	// 결재자로 세팅
        ...
        */
        ...
        {
        	// 사용치 않는 former 제거
        	var dsFormerInfo = this.dsFormerInfo;
        	var dsReceiver = this.dsReceiver;
        	dsFormerInfo.set_enableevent(false);
        	for(var i=dsFormerInfo.rowcount-1;i>=0;i--) {
        		if(dsFormerInfo.getColumn(i, "FORMER_YN") == "N") {
        			var nRow = dsReceiver.findRow("USER_ID", dsFormerInfo.getColumn(i, "FORMER_ID").replace(this.fvFormerPrefix, ""));
        			if(nRow < 0) {
        	...
        	// 없는 former 추가
        	for(var i=0;i<dsReceiver.rowcount;i++) {
        		var nRow = dsFormerInfo.findRow("FORMER_ID", this.fvFormerPrefix + dsReceiver.getColumn(i, "USER_ID"));
        		if(nRow < 0) {
        			var nRow = dsFormerInfo.addRow();
        			dsFormerInfo.setColumn(nRow, "DOC_ID", this.dsDocInfo.getColumn(0,"DOC_ID"));
        			dsFormerInfo.setColumn(nRow, "FORMER_ID", this.fvFormerPrefix + dsReceiver.getColumn(i, "USER_ID"));
        			dsFormerInfo.setColumn(nRow, "FORMER_NAME", dsReceiver.getColumn(i, "USER_NAME"));
        			dsFormerInfo.setColumn(nRow, "FORMER_YN", "N");
        		}
        	}
        	dsFormerInfo.set_enableevent(true);
        };
        ...
        */
        ...
        {
        	this.UbiDocuMaker00.set_autoSaveMsg(false);
        ...
        this.UbiDocuMaker00_onnotify = function(obj, e)
        {
        	if(e.data) {
        		...
        		if(e.data.UTYPE == "SAVE") {	// 저장성공
        			 if(e.data.STATUS == 1) {
        				this.UbiDocuMaker00.set_autoSaveMsg(true);
        				this.UbiDocuMaker00.sendMail(this.dsHistory, this.dsReceiver);
        			} else {
        				this.killTimer(99);
        				this.DivProcess.set_visible(false);
        				this.gfnAlert("msg.action.fail",[],"");	// 실패
        			}
        		} else if(e.data.UTYPE == "STARTMAIL") {	// 메일발송취소
        				this.DivProcess.form.ProgressBar00.set_pos(0);
        				this.DivProcess.set_visible(true);
        				this.setTimer(999,100);
        		} else if(e.data.UTYPE == "CANCELMAIL") {	// 메일발송취소
        			this.DivProcess.set_visible(false);
        			this.killTimer(999);
        		} else if(e.data.UTYPE == "SENDMAIL") {	// 메일
        			this.DivProcess.set_visible(false);
        			clearInterval(this.fvTimer);
        			this.killTimer(999);
        			if(e.data.STATUS == 1) {
        			} else {
        				//this.gfnAlert("msg.action.fail",[],"");	// 실패
        ...
        * description 메일발송 가짜 프로그레스바
        */
        this.docMail_ontimer = function(obj,e)
        {
        	console.log("=========timer", e.timerid, this.DivProcess.visible);
        	this.killTimer(e.timerid);
        	if(this.DivProcess.visible == true) {
        		var pos = this.DivProcess.form.ProgressBar00.pos;
        		this.DivProcess.form.ProgressBar00.set_pos(pos+5);
        		if(pos >= 100) {
        			this.killTimer(999);
        		} else {
        			this.setTimer(999,100);
        ...
        */
        ...
        this._fnAddRow = function()
        {
        	...
        	//this.dsReceiver.setColumn(nRow, "FORMER_ID", this.dsFormerInfo.getColumn(1, "FORMER_ID"));
        };
        ...
        {
        	var sTitle  = "사용자 선택";
        	var oArg    = { pvDocId: this.dsDocInfo.getColumn(0, "DOC_ID"),
        					pvSelectType: "USER",
        					pvUserType: "M"};
        	var oOption = {title:sTitle
        				,titlebar:true};
        	var sPopupCallBack = "fnPopupCallback";
        	this.gfnOpenPopup("DMUserPopup", "meet::docmanager/mtgSelectUserPu.xfdl", oArg, sPopupCallBack, oOption);
        };
        /**
        ...
        /**
         * @function dsReceiver_oncolumnchanged
         * @description 수신자 수기입력시 처리
         */
        this.dsReceiver_oncolumnchanged = function(obj,e)
        {
        	if(e.columnid == "USER_NAME" && !this.gfnIsNull(e.newvalue)) {
        		if(this.gfnIsNull(obj.getColumn(e.row, "USER_ID"))) {
        			var userId = this.createUID();
        			obj.setColumn(e.row, "USER_ID", userId);
        			var dsFormerInfo = this.dsFormerInfo;
        			var nRow = dsFormerInfo.addRow();
        			dsFormerInfo.setColumn(nRow, "DOC_ID", this.dsDocInfo.getColumn(0,"DOC_ID"));
        			dsFormerInfo.setColumn(nRow, "FORMER_ID", this.fvFormerPrefix + userId);
        			dsFormerInfo.setColumn(nRow, "FORMER_NAME", e.newvalue);
        			dsFormerInfo.setColumn(nRow, "FORMER_YN", "N");
        		}
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsReceiver.addEventHandler("oncolumnchanged",this.dsReceiver_oncolumnchanged,this);
        };
        this.loadIncludeScript("mtgManagerMail.xfdl");
