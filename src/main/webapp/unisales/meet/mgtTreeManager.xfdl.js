(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("17");
            obj.set_url("meet::mtgTreeSub.xfdl");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"432\"/><Column size=\"129\"/><Column size=\"129\"/><Column size=\"67\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"회의그룹\"/><Cell col=\"1\" text=\"그룹코드\"/><Cell col=\"2\" text=\"상위그룹코드\"/><Cell col=\"3\" text=\"정렬순서\"/></Band><Band id=\"body\"><Cell text=\"bind:DT_NAME\" displaytype=\"treeitemcontrol\" edittype=\"tree\" treelevel=\"bind:DT_LVL\"/><Cell col=\"1\" text=\"bind:DT_CD\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:HIPO_DT_CD\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:DT_ORDR\" textAlign=\"right\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","meet::mtgTreeSub.xfdl");
        };
        
        // User Script
        this.registerScript("mgtTreeManager.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("mgtTreeManager.xfdl");
