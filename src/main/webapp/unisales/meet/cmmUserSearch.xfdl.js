(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSearch","edtCode:-28.00","4","28","21",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edtWorkName","28","88","142","25",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtEmail","28.00","118","142","25",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtPhone","28.00","148","142","25",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            // Layout Functions
        	...
        	switch(sPopupId) {
        		case "orgUserListPu":
        			if( !this.gfnIsNull(sRtn) ){
        				var aRtn= sRtn.split("|");
        				this.edtCode.set_value(aRtn[2]);	// USER_ID
        				this.edtName.set_value(aRtn[1]);	// KORN_NM
        				this.edtUserId.set_value(aRtn[2]);	// USER_ID
        				this.edtWorkName.set_value(aRtn[3]);	// WKGD_NM
        				this.edtEmail.set_value(aRtn[4]);	// EMAIL
        				this.edtPhone.set_value(aRtn[5]);	// CELL_NUMB
        			}
        			break;
        		default:break;
        	}
        ...
        *******************************************************************************************************************************/
        ...
        this.btnSearch_onclick = function(obj,e)
        {
        	...
        	this.gfnOpenPopup("orgUserListPu", "meet::orgUserListPu.xfdl", oArg, sPopupCallBack, oOption);
        };
