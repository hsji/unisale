(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staUserId","480.00","160","340","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_LOGIN_Id");
            this.divLogin.addChild(obj.name, obj);

            obj = new Static("staPassword","480.00","230","340","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_LOGIN_Pw");
            this.divLogin.addChild(obj.name, obj);

            obj = new Edit("edtUserId","603.00","170","210","30",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("edtPassword","603.00","240","210","30",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staTitle","469.00","16","366","60",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_login_title");
            this.divLogin.addChild(obj.name, obj);

            obj = new CheckBox("chkSaveId","484.00","303","150","28",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("5");
            ...
            obj = new CheckBox("chkView","790.00","244","26","26",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("6");
            obj.set_cssclass("chk_login");
            obj.set_value("false");
            this.divLogin.addChild(obj.name, obj);

            obj = new Button("btnLogin","484.00","354","344","40",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("7");
            obj.set_text("LOGIN");
            ...
            obj = new Static("staUserId00","480.00","90","340","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_LOGIN_Language");
            this.divLogin.addChild(obj.name, obj);

            obj = new Static("sta00","523","101","68","23",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("11");
        ...
        // User Script
        this.registerScript("frmLogin_copy0.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("frmLogin_copy0.xfdl");
