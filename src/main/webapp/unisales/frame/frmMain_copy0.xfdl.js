(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("img00","0","0",null,"199","0",null,null,null,null,null,this.divMain.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("frmMain_copy0.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("frmMain_copy0.xfdl");
