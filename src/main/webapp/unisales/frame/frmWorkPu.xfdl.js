(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divMainTitle","0","0",null,"40","0",null,"1048",null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("div_POP_TitleBg");
            this.addChild(obj.name, obj);

            obj = new Button("btnImport",null,"6","28","28","42",null,null,null,null,null,this.divMainTitle.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_In");
            obj.set_tooltiptext("팝업결합");
            this.divMainTitle.addChild(obj.name, obj);

            obj = new Button("btnClose",null,"4","31","31","8",null,null,null,null,null,this.divMainTitle.form);
            obj.set_taborder("0");
