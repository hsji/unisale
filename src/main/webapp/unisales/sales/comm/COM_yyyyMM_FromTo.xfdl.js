(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_yyyyMM_From","0","0","140",null,null,"0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_url("sales::comm/COM_yyyyMM.xfdl");
            obj.getSetter("user_onchanged").set("from_onchanged");
            obj.set_formscrolltype("none");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","div_yyyyMM_From:0","0","10","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("~");
            obj.set_textAlign("center");
            this.addChild(obj.name, obj);

            obj = new Div("div_yyyyMM_To","Static00:9","0","140",null,null,"0",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_url("sales::comm/COM_yyyyMM.xfdl");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",300,24,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.div_yyyyMM_From.set_url("sales::comm/COM_yyyyMM.xfdl");
                ...
                p.div_yyyyMM_From.move("0","0","140",null,null,"0");

                p.Static00.set_taborder("1");
                p.Static00.set_text("~");
                p.Static00.set_textAlign("center");
                p.Static00.move("div_yyyyMM_From:0","0","10","20",null,null);

                p.div_yyyyMM_To.set_taborder("2");
                p.div_yyyyMM_To.set_url("sales::comm/COM_yyyyMM.xfdl");
                ...
                p.div_yyyyMM_To.move("Static00:9","0","140",null,null,"0");
            	}
            );
        ...
        {
            this._addPreloadList("fdl","sales::comm/COM_yyyyMM.xfdl");
        };
        
        // User Script
        this.registerScript("COM_yyyyMM_FromTo.xfdl", function() {
        this.pForm;
        this.pComp;
        ...
        this.loadIncludeScript("COM_yyyyMM_FromTo.xfdl");
