(function()
{
    return function()
    {
        ...
        {
            this.set_name("CO_StaffEvaluation");
            this.set_titletext("투입인력평가관리");
            ...
            obj.set_taborder("0");
            obj.set_text("Div00");
            obj.set_url("Technique::TS_StaffEvaluation.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_Cancel",null,null,"70","22","4","9",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("닫기");
            ...
            obj.set_taborder("4");
            obj.set_text("투입인력평가관리");
            obj.set_cssclass("sta_POP_Title");
            obj.getSetter("TL_SEQ").set("0");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        {
            this._addPreloadList("fdl","Technique::TS_StaffEvaluation.xfdl");
        };
        
        // User Script
        this.addIncludeScript("CO_StaffEvaluation.xfdl","Script::CommTrans.xjs");
        this.addIncludeScript("CO_StaffEvaluation.xfdl","Script::CommGrid.xjs");
        this.addIncludeScript("CO_StaffEvaluation.xfdl","Script::CommUtil.xjs");
        this.addIncludeScript("CO_StaffEvaluation.xfdl","Script::ext_CommEco.xjs");
        this.registerScript("CO_StaffEvaluation.xfdl", function() {
        /************************************************************************************************
         * 01. 업무구분 : 프로젝트관리
         ...
         * FORM 영역
         ************************************************************************************************/
         this.CO_StaffEvaluation_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.CO_StaffEvaluation_onload,this);
        ...
        this.loadIncludeScript("CO_StaffEvaluation.xfdl");
