(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("TS_StaffInfoReg_copy2.xfdl","Script::CommSystem.xjs");
        this.addIncludeScript("TS_StaffInfoReg_copy2.xfdl","Script::CommTrans.xjs");
        this.addIncludeScript("TS_StaffInfoReg_copy2.xfdl","Script::CommUtil.xjs");
        this.addIncludeScript("TS_StaffInfoReg_copy2.xfdl","Script::CommGrid.xjs");
        this.registerScript("TS_StaffInfoReg_copy2.xfdl", function() {
        /************************************************************************************************
        * 01. 업무구분 : 공통 - 공통
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("TS_StaffInfoReg_copy2.xfdl");
