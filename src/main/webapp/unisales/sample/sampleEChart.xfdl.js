(function()
{
    return function()
    {
        ...
        {
            this.set_name("sampleEChartAll");
            this.set_titletext("sampleEChartAll");
            ...
            obj = new Div("divStackChart","2.86%","79","26%","350",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_url("common::cmmEChartAll.xfdl");
            ...
            obj = new Div("sampleEChart","89.43%","79","26%","350",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("");
            obj.set_url("common::cmmEChartAll.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnMake","22","10","116","34",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("생성");
            ...
            //-- Default Layout : this.sampleEChart
            obj = new Layout("default","",0,0,this.sampleEChart.form,function(p){});
            this.sampleEChart.form.addLayout(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","common::cmmEChartAll.xfdl");
        };
        
        // User Script
        this.registerScript("sampleEChart.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.btnMake_onclick = function(obj,e)
        {
        	this.fnMake();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnMake.addEventHandler("onclick",this.btnMake_onclick,this);
        };
        this.loadIncludeScript("sampleEChart.xfdl");
