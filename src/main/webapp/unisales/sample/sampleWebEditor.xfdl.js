(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnGetData",null,"10","100","28","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Editor->Nexa");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetData",null,"10","100","28","btnGetData:3",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Nexa->Editor");
            this.addChild(obj.name, obj);

            obj = new WebBrowser("webBrowser","0","btnSetData:5",null,null,"20","150",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnShowView",null,"10","89","28","btnSetData:3",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("상세보기");
            this.addChild(obj.name, obj);

            obj = new TextArea("txtValue","0","webBrowser:50",null,"99","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_wordWrap("char");
            this.addChild(obj.name, obj);

            obj = new Button("btn00",null,null,"162","28","20","txtValue:5",null,null,null,null,this);
            obj.set_taborder("5");
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.webBrowser.addEventHandler("onloadcompleted",this.webBrowser_onloadcompleted,this);
            this.webBrowser.addEventHandler("onusernotify",this.webBrowser_onusernotify,this);
