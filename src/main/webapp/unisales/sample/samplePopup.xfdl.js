(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnShowModaless",null,"395","60","92","25",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("show");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkDualMonitor","14","524","123","34",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("듀얼 모니터");
            this.addChild(obj.name, obj);

            obj = new Button("btnCallPopup",null,"489","60","92","25",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("팝업\r\n호출");
            this.addChild(obj.name, obj);
            // Layout Functions
