(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_MenuCd","18","248","113","36",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("우편번호");
            obj.set_cssclass("sta_WF_DeatilLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("edtBasAddr","247","253","448","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edtDetailAddr","698","253",null,"28","27",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_maxlength("200");
            obj.set_displaynulltext("상세주소");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSculZip","123","253","92","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_displaynulltext("우편번호");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearchPost","218","253","26","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_SearchSmall");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaGuide","0","0",null,"220","20",null,null,null,null,null,this);
            obj.set_taborder("5");
