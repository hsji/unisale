(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"sj\" type=\"STRING\" size=\"256\"/><Column id=\"wrter\" type=\"STRING\" size=\"256\"/><Column id=\"cn\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"sj\">제목입니다.</Col><Col id=\"wrter\">홍길동</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Div("divContent","0","10",null,null,"20","40",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnGoback",null,"divContent:7","89","28","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("돌아가기");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContent.form.webCn.addEventHandler("onloadcompleted",this.divContent_webCn_onloadcompleted,this);
