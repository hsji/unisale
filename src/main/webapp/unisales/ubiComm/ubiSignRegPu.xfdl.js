(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("서명이미지등록");
            this.Tab00.addChild(obj.name, obj);

            obj = new ImageViewer("img00","10","10",null,null,"10","35",null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("0");
            obj.set_border("1px solid #dddddd");
            obj.set_stretch("fixaspectratio");
            this.Tab00.Tabpage2.addChild(obj.name, obj);

            obj = new FileUpload("fud00",null,"233","80","24","11",null,null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("1");
            obj.set_itemheight("24");
            obj.set_buttonsize("80");
            obj.set_buttontext("사진등록");
            obj.set_filefilter("*.png;*.gif");
            this.Tab00.Tabpage2.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("ubiSignRegPu.xfdl", function() {
        this.fvIsExist = true;
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.Tab00.Tabpage2.form.fud00.addEventHandler("onitemchanged",this.fud00_onitemchanged,this);
            this.dsList.addEventHandler("onrowposchanged",this.dsList_onrowposchanged,this);
        };
        this.loadIncludeScript("ubiSignRegPu.xfdl");
