(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"FIELD_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"FIELD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"FIELD_MASK\" type=\"STRING\" size=\"256\"/><Column id=\"FORMER_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"5\"/><Column size=\"126\"/><Column size=\"5\"/><Column size=\"160\"/><Column size=\"5\"/><Column size=\"100\"/><Column size=\"5\"/><Column size=\"87\"/><Column size=\"5\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"5\"/><Row size=\"30\"/><Row size=\"5\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"필드ID\" color=\"#29292a\" border=\"0px none\"/><Cell col=\"2\"/><Cell col=\"3\" text=\"필드명\" color=\"#29292a\"/><Cell col=\"4\"/><Cell col=\"5\" text=\"MASK\" color=\"#29292a\"/><Cell col=\"6\"/><Cell col=\"7\" text=\"수신그룹\" color=\"#29292a\"/><Cell col=\"8\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" cssclass=\"grd_MF_bottom\"/><Cell col=\"2\"/><Cell col=\"3\" cssclass=\"grd_MF_bottom\"/><Cell col=\"4\"/><Cell col=\"5\" cssclass=\"grd_MF_bottom\"/><Cell col=\"6\"/><Cell col=\"7\" cssclass=\"grd_MF_bottom\"/><Cell col=\"8\"/><Cell row=\"1\" expandsize=\"25\" displaytype=\"normal\" padding=\"0px\" cssclass=\"grd_MF_right\"/><Cell row=\"1\" col=\"1\" text=\"bind:FIELD_ID\" displaynulltext=\"aaaaa\" expandshow=\"hide\" expandsize=\"25\" displaytype=\"normal\" edittype=\"normal\" padding=\"0px\" cssclass=\"grd_MF_edit\" expandimage=\"url(&apos;theme://images/btn_WF_DetailSearchN.png&apos;)\" editinputtype=\"alpha,english,digit,number,numberandenglish\"/><Cell row=\"1\" col=\"2\" expandsize=\"25\" displaytype=\"normal\" padding=\"0px 0px 0px 5px\" cssclass=\"grd_MF_right\"/><Cell row=\"1\" col=\"3\" text=\"bind:FIELD_NAME\" expandsize=\"25\" displaytype=\"normal\" edittype=\"normal\" padding=\"0px 0px 0px 5px\" cssclass=\"grd_MF_edit\"/><Cell row=\"1\" col=\"4\" cssclass=\"grd_MF_left\" border=\"0px none,1px solid #dbdee2\"/><Cell row=\"1\" col=\"5\" text=\"bind:FIELD_MASK\" expandsize=\"30\" displaytype=\"normal\" edittype=\"normal\" padding=\"0px 0px 0px 5px\" cssclass=\"grd_MF_edit\"/><Cell row=\"1\" col=\"6\" cssclass=\"grd_MF_left\" border=\"0px none,1px solid #dbdee2\"/><Cell row=\"1\" col=\"7\" text=\"bind:FORMER_ID\" expandshow=\"expr:currow==0?&apos;hide&apos;:&apos;show&apos;\" expandsize=\"30\" displaytype=\"combotext\" edittype=\"combo\" expandimage=\"url(&apos;theme://images/btn_TF_Close_O.png&apos;)\" padding=\"0px 0px 0px 5px\" cssclass=\"grd_MF_edit\" combodataset=\"dsFormerInfo\" combocodecol=\"FORMER_ID\" combodatacol=\"FORMER_NAME\"/><Cell row=\"1\" col=\"8\" cssclass=\"grd_MF_left\"/><Cell row=\"2\"/><Cell row=\"2\" col=\"1\"/><Cell row=\"2\" col=\"2\"/><Cell row=\"2\" col=\"3\"/><Cell row=\"2\" col=\"4\"/><Cell row=\"2\" col=\"5\"/><Cell row=\"2\" col=\"6\"/><Cell row=\"2\" col=\"7\"/><Cell row=\"2\" col=\"8\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("ubiCmmFieldSet.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        /**
         * @function _setData
         * @description 사용자 정보 데이터셋을 전달받는다 - docFormNewPu에서 호출.
         */
        ...
        /**
         * @function _setFormerData
         * @description 작성그룹 정보 데이터셋을 전달받는다 - docFormNewPu에서 호출.
         */
        this._setFormerData = function(objFormerInfo)
        {
        	this.dsFormerInfo.copyData(objFormerInfo);
        };
        ...
        {
        	var no, name, former, email, checkval;
        	for(var i=0,len=this.dsFieldInfo.rowcount;i<len;i++) {
        		no = this.dsFieldInfo.getColumn(i, "FIELD_NAME");
        		name = this.dsFieldInfo.getColumn(i, "FIELD_ID");
        		former = this.dsFieldInfo.getColumn(i, "FORMER_ID");
        		if(this._isNull(no) || this._isNull(name) || this._isNull(former)) {
        			this.dsFieldInfo.set_rowposition(i);
        ...
        */
        ...
        this._fnAddRow = function()
        {
        	...
        	this.dsFieldInfo.setColumn(nRow, "FORMER_ID", this.dsFormerInfo.getColumn(0, "FORMER_ID"));
        ...
        this.loadIncludeScript("ubiCmmFieldSet.xfdl");
