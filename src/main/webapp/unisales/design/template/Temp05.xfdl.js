(function()
{
    return function()
    {
        ...
        {
            this.set_name("Temp05");
            this.set_titletext("Master-Detail(1n)");
            ...
            obj = new Grid("grd00","0","236",null,null,"20","0",null,null,"353",null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta01","0","193","342","43",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("상세목록");
            obj.set_cssclass("sta_WF_SubTitle");
            this.addChild(obj.name, obj);

            obj = new Div("div01","0","93",null,"100","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk00","626","71","150","24",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("27");
            obj.set_text("사용");
            obj.set_value("true");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Button("btn48",null,"60","86","28","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Button("btn48_00",null,"60","86","28","btn48:3",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divCmmnBtn",null,"202","572","28","20",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Temp05.xfdl", function() {
        /**
        *  DevPACK
        *  @FileName 	Temp05.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("Temp05.xfdl");
