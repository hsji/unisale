(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static04_00","932","0","30","5",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("H5");
            ...
            obj = new Button("btn48",null,"5","86","28","0",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Button("btn48_00",null,"5","86","28","89",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);
