(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Master-Detail-V+V+V(n:n:n)");
            ...
            obj = new Grid("grd00","0","93",null,"25%","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btn36","164","0","71","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            obj.set_text("행삭제");
            ...
            obj = new Button("btn35","89","0","72","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("3");
            obj.set_text("행추가");
            ...
            obj = new Button("btn48","0","0","86","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            obj.set_visible("false");
            ...
            obj = new Button("btnCust00_00_00","348","0","119","28",null,null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("0");
            obj.set_text("엑셀다운로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelSave");
            ...
            obj = new Button("btnCust01_00_00","238","0","107","28",null,null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("1");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelUp");
            ...
            obj = new Button("btn36","164","0","71","28",null,null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("2");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            obj.set_visible("false");
            ...
            obj = new Button("btn35","89","0","72","28",null,null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("3");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_Add");
            obj.set_visible("false");
            ...
            obj = new Button("btn48","0","0","86","28",null,null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("4");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            obj.set_visible("false");
            ...
            obj = new Static("sta01_00","-1","grd01:0","342","43",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("상세리스트02");
            obj.set_cssclass("sta_WF_SubTitle");
            this.addChild(obj.name, obj);

            obj = new Grid("grd01_00","0","sta01_00:0",null,null,"20","0",null,null,"189",null,this);
            obj.set_taborder("10");
            obj.set_binddataset("ds_grid");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"160\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"160\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"60\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"에디트\"/><Cell col=\"3\" text=\"필수\" cssclass=\"essential\"/><Cell col=\"4\" text=\"숫자\"/><Cell col=\"5\" text=\"익스팬드\"/><Cell col=\"6\" text=\"콤보박스\"/><Cell col=\"7\" text=\"캘린더\"/><Cell col=\"8\" text=\"중앙정렬\"/><Cell col=\"9\" text=\"버튼\"/></Band><Band id=\"body\"><Cell text=\"bind:chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:No\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:Edi\" displaytype=\"editcontrol\" edittype=\"normal\"/><Cell col=\"3\" text=\"bind:Essential\" displaytype=\"text\"/><Cell col=\"4\" text=\"bind:Num\" displaytype=\"number\"/><Cell col=\"5\" text=\"bind:Expand\" displaytype=\"editcontrol\" expandshow=\"show\" expandsize=\"30\" edittype=\"normal\"/><Cell col=\"6\" text=\"bind:Cmb\" displaytype=\"combocontrol\" edittype=\"combo\"/><Cell col=\"7\" text=\"bind:Cal\" displaytype=\"calendarcontrol\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"8\" text=\"bind:CenterAlign\" displaytype=\"text\"/><Cell col=\"9\" text=\"bind:Btn\" displaytype=\"buttoncontrol\" edittype=\"button\"/></Band></Format></Formats>");
            ...
            obj = new Div("div00_00_00",null,"grd01:10","467","28","21",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new Button("btnCust00_00_00","348","0","119","28",null,null,null,null,null,null,this.div00_00_00.form);
            obj.set_taborder("0");
            obj.set_text("엑셀다운로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelSave");
            ...
            obj = new Button("btnCust01_00_00","238","0","107","28",null,null,null,null,null,null,this.div00_00_00.form);
            obj.set_taborder("1");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelUp");
            ...
            obj = new Button("btn36","164","0","71","28",null,null,null,null,null,null,this.div00_00_00.form);
            obj.set_taborder("2");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            obj.set_visible("false");
            ...
            obj = new Button("btn35","89","0","72","28",null,null,null,null,null,null,this.div00_00_00.form);
            obj.set_taborder("3");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_Add");
            obj.set_visible("false");
            ...
            obj = new Button("btn48","0","0","86","28",null,null,null,null,null,null,this.div00_00_00.form);
            obj.set_taborder("4");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("Temp08.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("Temp08.xfdl");
