(function()
{
    return function()
    {
        ...
        {
            this.set_name("Temp10");
            this.set_titletext("Master-Detail-H+H+H(n:n:n)");
            ...
            obj = new Static("sta00","0","50","214","43",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("서브타이틀");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);

            obj = new Grid("grd00","0","93",null,null,"68.48%","0",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Div("div01",null,"60","367","33","68.48%",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new Button("btnCust00_00_00","248","0","119","28",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("0");
            obj.set_text("엑셀다운로드");
            ...
            obj = new Button("btnCust01_00_00","138","0",null,"28","btnCust00_00_00:3",null,null,null,null,null,this.div01.form);
            obj.set_taborder("1");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            ...
            obj = new Grid("grd00_00","grd00:20","93",null,null,"35.24%","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_binddataset("ds_grid");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"160\"/><Column size=\"60\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"에디트\"/><Cell col=\"3\" text=\"필수\" cssclass=\"essential\"/></Band><Band id=\"body\"><Cell text=\"bind:chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:No\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:Edi\" displaytype=\"editcontrol\" edittype=\"normal\"/><Cell col=\"3\" text=\"bind:Essential\" displaytype=\"text\"/></Band></Format></Formats>");
            ...
            obj = new Grid("grd00_00_00","grd00_00:20","93",null,null,"20","0",null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_binddataset("ds_grid");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"160\"/><Column size=\"60\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"에디트\"/><Cell col=\"3\" text=\"필수\" cssclass=\"essential\"/></Band><Band id=\"body\"><Cell text=\"bind:chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:No\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:Edi\" displaytype=\"editcontrol\" edittype=\"normal\"/><Cell col=\"3\" text=\"bind:Essential\" displaytype=\"text\"/></Band></Format></Formats>");
            ...
            obj = new Static("sta00_00_00","grd00_00:20","50","214","43",null,null,null,null,null,null,this);
            obj.set_taborder("8");
        ...
        // User Script
        this.registerScript("Temp10.xfdl", function() {
        /**
        *  DevPACK
        *  @FileName 	Temp10.xfdl
        *  @Creator 	TOBESOFT
