(function()
{
    return function()
    {
        ...
        {
            this.set_name("scheduleMainFm_JY");
            ...
            obj = new Button("btnToday","20","10","54","28",null,null,null,null,null,null,this.divCal.form.div_CalHead.form);
            obj.set_taborder("0");
            ...
            obj = new CheckBox("chk00","btnToday:3","10","120","28",null,null,null,null,null,null,this.divCal.form.div_CalHead.form);
            obj.set_taborder("8");
            obj.set_cssclass("chk_WF_Cal");
            this.divCal.form.div_CalHead.addChild(obj.name, obj);
            ...
            obj = new Div("divList",null,"18","281",null,"20","20",null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("scheduleMainFm_JY.xfdl", function() {
        /**
        *  DevPACK
        *  @FileName 	scheduleMainFm_JY.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        ...
        this.fnTranSearchScdInfo = function(sScdCd)
        {
        	...
        	this.dsSearch.setColumn(nRow, "SCD_CD", sScdCd);
        	this.dsSearch.setColumn(nRow, "DEPT_CD", this.fvDeptCd);
        	this.dsSearch.setColumn(nRow, "USER_ID", nexacro.getApplication().gdsUser.getColumn(0, "USER_ID"));
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("scheduleMainFm_JY.xfdl");
