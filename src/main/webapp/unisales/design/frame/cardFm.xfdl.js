(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staTitle000","0","0","83","38",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle001","0","staTitle000:-1","83","38",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("작성자");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle","staTitle000:-1","0",null,"38","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle002","50%","37","82","38",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록일자");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("staInpId","staTitle001:-1","37",null,"38","staTitle002:-1",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staDttm","staTitle002:-1","37",null,"38","0",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Div("divBtn00",null,null,"275","30","0","0",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("");
            ...
            obj = new Div("divCont","0","staInpId:-1",null,"193","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);

            obj = new Static("staBg000","0","0",null,null,"0","0",null,null,null,null,this.divCont.form);
            obj.set_taborder("2");
            obj.set_text("Static02");
            obj.set_cssclass("sta_WF_LabelBg");
            this.divCont.addChild(obj.name, obj);

            obj = new Static("staTitle04","0","0","83",null,null,"0",null,null,null,null,this.divCont.form);
            obj.set_taborder("1");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_Label");
            this.divCont.addChild(obj.name, obj);

            obj = new WebBrowser("webEditor","staTitle04:4","5",null,null,"5","5",null,null,null,null,this.divCont.form);
            obj.set_taborder("0");
            this.divCont.addChild(obj.name, obj);

            obj = new Div("divFile","0","divCont:-1",null,"60","0",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTitle000","0","0","83",null,null,"0",null,null,null,null,this.divFile.form);
            obj.set_taborder("1");
            obj.set_text("첨부파일");
            obj.set_cssclass("sta_WF_Label");
            this.divFile.addChild(obj.name, obj);

            obj = new Grid("grdFile","staTitle000:4","5",null,null,"5","5",null,null,null,null,this.divFile.form);
            obj.set_taborder("2");
            obj.set_binddataset("dsFile");
            obj.set_autofittype("col");
            obj.set_cssclass("grd_MF_Notice");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"549\"/><Column size=\"63\"/></Columns><Rows><Row size=\"26\"/></Rows><Band id=\"body\"><Cell text=\"bind:OTXT_FILE_NM\"/><Cell col=\"1\" text=\"다운로드\" displaytype=\"buttoncontrol\" edittype=\"button\"/></Band></Format></Formats>");
            this.divFile.addChild(obj.name, obj);

            obj = new Static("staCntFile","staTitle000:-83","staTitle000:-28","83","22",null,null,null,null,null,null,this.divFile.form);
            obj.set_taborder("3");
            obj.set_text("(0건)");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",730,360,this,function(p){});
            ...
            obj = new BindItem("item1","staInpId","text","dsList","INPT_EMP_NO");
            this.addChild(obj.name, obj);
            obj.bind();
