(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdCombo","0","37",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new CheckBox("chkHeader","5","9","25","20",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("chk_WF_GridFilter");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Combo("cboOperater",null,"7","120","24","74",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("cmb_WF_GridFilter");
            ...
            obj = new Edit("edtFilter","5","7",null,"24","cboOperater:3",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("edi_WF_GridFilter");
            obj.set_displaynulltext("Search");
            this.addChild(obj.name, obj);

            obj = new Button("btnApply",null,"7","64","24","7",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Apply");
            obj.set_cssclass("btn_WF_commSave");
            this.addChild(obj.name, obj);

            obj = new Calendar("calFilter","5","50",null,"24","200",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_tabstop("false");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",380,190,this,function(p){});
