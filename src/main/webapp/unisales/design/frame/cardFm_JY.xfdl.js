(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staInpId","30","18","100","38",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_PostID");
            obj.set_text("김지영(jyk) ");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Static("staDttm","staInpId:10","18",null,"38","500",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btnModi",null,"0","50","28","btnDelete:3",null,null,null,null,null,this.divBtn00.form);
            obj.set_taborder("0");
            obj.set_text("수정");
            obj.set_cssclass("btn_WF_Crud");
            this.divBtn00.addChild(obj.name, obj);

            obj = new Div("divFile","30",null,null,"60","30","60",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divCont","30","110",null,null,"30","divFile:0",null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new WebBrowser("webEditor","5","5",null,null,"5","5",null,null,null,null,this.divCont.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("cardFm_JY.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("cardFm_JY.xfdl");
