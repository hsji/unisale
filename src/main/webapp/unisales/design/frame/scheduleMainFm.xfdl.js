(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYYMM\" type=\"STRING\" size=\"256\"/><Column id=\"SCD_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"SECTDATE\" type=\"STRING\" size=\"256\"/><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"srchGubun\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"srchGubun\">down</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn00","btnToday:3","10","54","28",null,null,null,null,null,null,this.divCal.form.div_CalHead.form);
            obj.set_taborder("8");
            obj.set_cssclass("btn_WF_CalDown");
            this.divCal.form.div_CalHead.addChild(obj.name, obj);

            obj = new Button("btn01","btn00:0","10","54","28",null,null,null,null,null,null,this.divCal.form.div_CalHead.form);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WF_CalUp");
            this.divCal.form.div_CalHead.addChild(obj.name, obj);
            ...
            obj = new Button("btn00_00","86","76","54","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_CalDownS");
            this.addChild(obj.name, obj);

            obj = new Button("btn01_00","140","76","54","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	if(this.gfnIsNull(this.fvScdCd)){
        		...
        		this.divCal.form.div_CalHead.form.chkGubun.set_value("up");
        		this.divCal.form.div_CalHead.form.chkGubun.set_visible(true);
        	}
        ...
        *******************************************************************************************************************************/
        ...
        // 검색조건 변경시 스케쥴 재조회
        this.divCal_div_CalHead_chkGubun_onchanged = function(obj,e)
        {
        	this.fnSetDate();
        	//체크박스 선택 시 포커스가 남아있어서 강제이동시킴
        	var objComp = this.divCal.form.div_CalHead.form.getNextComponent(obj);
        	objComp.setFocus();
        };
