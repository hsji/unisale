(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtTitle","staTitle02:4","edtInqCnt:9",null,"24","5",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("7");
            this.divContents.addChild(obj.name, obj);
            ...
            obj = new TextArea("txa00","92","10","28","40",null,null,null,null,null,null,this.divContents.form.divCont.form);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item3","divContents.form.divCont.form.txa00","value","dsList","CNTN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("boardUpdatePu.xfdl", function() {
        /**
        *  DevPACK
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("boardUpdatePu.xfdl");
