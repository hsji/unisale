(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divBtn",null,"divContents:20","247","28","25",null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);
        ...
        *******************************************************************************************************************************/
        this.fnSetFormInit = function ()
        {
        	...
        	if( this.fvLoginUser == sInputUser || this.fvMgrCd == this.fvLoginUser || this.fvAutnYn == "Y"){
        		...
        		this.divBtn00.form.btnModi.set_width(69);
